	...
	logical ppwf,pwf,trnl,energy,potbin,bener(mp),hat,nosol,pralpha,
     ...
     x          nosub,itt,treverse,complexbins

c CDCC NAMELISTS FOR INPUT:
        namelist/cdcc/ hcm,rmatch,rintp,rsp,
     x          elab,quasi,ips,it0,iter,pset,msolve,jset,
     ...
     x          nfus,kfus,wdisk,treverse,complexbins,initwf
...
!	write(6,*) ' fort.6 (stdout) has namelist output'
	...
	subroutine defaults
	 ...
	 jump(:)=0; jbord(:)=0; 
         ...
         smallchan=1d-12; smallcoup=1d-12; numnode=0; msolve=0
